...
import { useState } from "react";
import SearchBooksUseCase from "../../../usecases/search_book/search_book_service";
import BookRepository from "../../../infrastructure/repositories/book_repository";

function Search({ setResults }) {
    const [input, setInput] = useState("");

    const searchBooksUseCase = new SearchBooksUseCase(new BookRepository());
    ...
    const handleChange = async (value) => {
        ...
        const books = await searchBooksUseCase.execute(value);
        setResults(books);
    };
