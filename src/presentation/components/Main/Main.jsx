...
// import { fetchBooks, fetchCategories } from "../../../service/apiservice";
...
// Import Use Cases
import GetAllBooksUseCase from "../../../usecases/book/get_all_book_service.js";
import GetAllCategoriesUseCase from "../../../usecases/categori/get_all_categori_service.js";
...
const Main = () => {
  ...
  // ✅ ĐÚNG: Khởi tạo Repository trước, sau đó inject vào Use Case
  const bookRepository = new BookRepository();
  const categoryRepository = new CategoryRepository();
  
  const getBooksUseCase = new GetAllBooksUseCase(bookRepository);
  const getCategoriesUseCase = new GetAllCategoriesUseCase(categoryRepository);

  // Lấy category qua usecase
  useEffect(() => {
    const loadCategories = async () => {
      try {
      ...
      if (selectedCategory) {
        const filtered = data.filter(
          (book) =>
            book.category &&
            book.category.id &&
            String(book.category.id) === String(selectedCategory)
        );
        setProducts(filtered);
      } else {
        setProducts(data);
          ...
          <div className="d-flex justify-content-around">
            ...
            <a className="text-decoration-none text-dark" href="">
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M11.5 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L11 2.707V14.5a.5.5 0 0 0 .5.5M4.5 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L4 13.293V1.5a.5.5 0 0 1 .5-.5"
                />
              </svg>
            </a>
          </div>
        ...
        <div className="mt-4 mx-5">
          <div className="row">
            ...
            <div className="col-md-2 d-lg">
              ...
              {/* Nhà cung cấp + rating giữ nguyên */}
              <div className="border-0 px-3">
                <h6 style={{ fontSize: "15px" }}>Nhà cung cấp</h6>
                    ...
                    products.map((item, index) => (
                      ...
                      >
                        <div className="card">
                         <img
  style={{ width: "100%", height: "35%" }}
  src={item.images?.[0]?.baseUrl || "/placeholder.png"}
  className="card-img-top my-1"
  alt={item.name}
/>
                          <div className="card-body">
                            ...
                            <p className="card-text">
                              Đánh giá: {item.ratingAverage ?? "Chưa có"} ⭐
                            </p>
        ...
        >
          <ul className="pagination d-flex justify-content-center">
            <li className="page-item">
              <a className="page-link text-white bg-primary" href="#">
                1
              </a>
            </li>
